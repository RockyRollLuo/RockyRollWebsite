    ...
    <div class="row">
        <div class="12u">
            ...
            <section class="box">
                <h3>Image</h3>
                <h4>Fit</h4>
                <span class="image fit"><img src="<%=basePath%>/resource/img/blog/pic04.jpg" alt=""/></span>
                <div class="box alt">
                    <div class="row no-collapse half uniform">
                        <div class="4u"><span class="image fit"><img src="<%=basePath%>/resource/img/blog/pic04.jpg"
                                                                     alt=""/></span></div>
                        <div class="4u"><span class="image fit"><img src="<%=basePath%>/resource/img/blog/pic04.jpg"
                                                                     alt=""/></span></div>
                        <div class="4u"><span class="image fit"><img src="<%=basePath%>/resource/img/blog/pic04.jpg"
                ...
                <h4>Left &amp; Right</h4>
                <p><span class="image left"><img src="<%=basePath%>/resource/img/blog/pic05.jpg" alt=""/></span>Fringilla
                    nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget. tempus euismod. Vestibulum
                ...
                <p><span class="image right"><img src="<%=basePath%>/resource/img/blog/pic05.jpg" alt=""/></span>Fringilla
                    nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget. tempus euismod. Vestibulum
                    ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing
                    accumsan eu faucibus. Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus
                    euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis
...
<footer id="footer">
    <ul class="icons">
        ...
        <li><a href="#" class="icon fa-tencent-weibo"><span class="label">tencent-weibo</span></a></li>
        <li><a href="#" class="icon fa-cloud-download"><span class="label">cloud-download</span></a></li>
    ...
    <ul class="copyright">
        ...
        <li>Design: <a href="/index">RockyRoll</a></li>
    </ul>
</footer>
