$(function ($) {
    ...
    skel.init({
        ...
        breakpoints: {
            global: {
                range: '*',
                href: basePath+'/resource/css/blog/style.css',
                containers: '60em',
                grid: {gutters: {vertical: '2em', horizontal: 0}}
            },
            wide: {range: '-1680', href: basePath+'/resource/css/blog/style-wide.css'},
            normal: {
                range: '-1280',
                href: basePath+'/resource/css/blog/style-normal.css',
                grid: {gutters: {vertical: '1.5em'}},
                viewport: {scalable: false}
            },
            narrow: {range: '-980', href: basePath+'/resource/css/blog/style-narrow.css', containers: '90%'},
            narrower: {range: '-840', href: basePath+'/resource/css/blog/style-narrower.css', grid: {collapse: 1}},
            mobile: {
                range: '-736',
                href: basePath+'/resource/css/blog/style-mobile.css',
                containers: '100%',
                grid: {gutters: {vertical: '1em'}}
            },
            mobilep: {range: '-480', href: basePath+'/resource/css/blog/style-mobilep.css', grid: {collapse: 2}}
        },
        plugins: {
            layers: {
