...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/css/common/jquery-ui.css"/>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/css/common/jquery-ui.structure.css"/>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/css/common/jquery-ui.theme.css"/>
